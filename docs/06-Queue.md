...
The README and `docs/00` are this repository's own documents and bump no
`VERSION` on their own; `discuss-adds-queue-line` does, because a target
receives a fourth command.
